...
export default function AIBubble() {
    ...
    return (
        <button
            className="fixed bottom-10 right-10 z-[100] w-16 h-16 rounded-full bg-gradient-to-br from-[#1a1a1a]/90 via-[#0d0d0d]/90 to-[#000000]/90 flex items-center justify-center shadow-[0_8px_32px_rgba(0,0,0,0.5)] border border-white/10 group overflow-hidden transition-all duration-300 hover:scale-110 hover:shadow-[0_0_20px_rgba(255,255,255,0.2)] active:scale-95 animate-in zoom-in slide-in-from-bottom-10 fade-in duration-700 ease-out cursor-default backdrop-blur-sm opacity-90 hover:opacity-100"
        >
            {/* Ambient Glow */}
